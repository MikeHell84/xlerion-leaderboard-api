            ...
            {stats && (
                <div className="space-y-4">
                    <div className="p-4 bg-[#1a1a1a] rounded">
                        <h3 className="text-2xl font-bold">{stats.displayName}</h3>
                        <div className="text-gray-400">{stats.username} — {stats.region}</div>
                    </div>

                    <div className="grid grid-cols-4 gap-4">
                        <div className="p-4 bg-[#1a1a1a] rounded">Total Partidas<br /><strong>{stats.totalGames}</strong></div>
                        <div className="p-4 bg-[#1a1a1a] rounded">Mejor Score<br /><strong>{stats.bestScore}</strong></div>
                        <div className="p-4 bg-[#1a1a1a] rounded">Score Promedio<br /><strong>{Math.round(stats.averageScore)}</strong></div>
                        <div className="p-4 bg-[#1a1a1a] rounded">Puntos de Logros<br /><strong>{stats.achievementPoints}</strong></div>
                    </div>
